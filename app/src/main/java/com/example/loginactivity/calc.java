...
public class calc extends AppCompatActivity {
    ...
    private void viewSetup() {
        ...
        b6 = findViewById(R.id.button21);
        b7 = findViewById(R.id.button22);
        b8 = findViewById(R.id.button23);
        b9 = findViewById(R.id.button24);
        b0 = findViewById(R.id.button25);
        b_equal = findViewById(R.id.button_equal2);
        b_multi = findViewById(R.id.button_multi2);
        b_divide = findViewById(R.id.button_divide2);
        b_add = findViewById(R.id.button_add2);
        b_sub = findViewById(R.id.button_sub2);
        b_clear = findViewById(R.id.button_clear2);
        b_dot = findViewById(R.id.button_dot2);
        b_para1 = findViewById(R.id.button_para3);

        t1 = findViewById(R.id.input2);
        t2 = findViewById(R.id.output2);
